...
// Le niveau effectif est dérivé par priorité Commande > Marque > Plateforme > StockLibre ;
// les FK des niveaux moins précis restent envoyées (traçabilité) — le backend les stocke.
